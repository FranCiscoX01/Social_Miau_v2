...
export default class MostLikedCard extends Component {
    render() {
        return (
                  ...
                  <Card style={{ borderRadius: '15px' }} className="shadow p-3 mb-5 bg-white">
                    ...
                    <div className="row">
                      { !this.props.Loadind
                        ...
                        :
                        <div className="col-12 text-center">
                          <LikeTwoTone style={{ fontSize: '60px' }} spin />
                          <p>Loading...</p>
                        </div>
                      }
                    </div>
...
if (document.getElementById('most-liked-card')) {
    ReactDOM.render(<MostLikedCard />, document.getElementById('most-liked-card'));
}
